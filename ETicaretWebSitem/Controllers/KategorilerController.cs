...
namespace ETicaretWebSitem.Controllers
{
    public class KategorilerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KategoriID,KategoriAD")] Kategoriler kategoriler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KategoriID,KategoriAD")] Kategoriler kategoriler)
        {
            if (ModelState.IsValid)
            {
